	...
	String  path = System.getProperty("user.dir") + "\\TestData\\UI.properties";
	   ...
	   //Locating the signin link
		...
		//Locating the Password text filed
				...
				//Assertion for invite page
				public WebElement invitepageassert()   
				{		
					try {
						WebDriverWait wait= new WebDriverWait(driver,60);
						System.out.println("	*Invite page text should be displayed");
						WebElement ele =  wait.until(ExpectedConditions.elementToBeClickable(objMap.getLocator("invitepageassert")));
						return   ele;
					} catch (Exception e){
						Reporter.log("Invite page text not displayed-----"+e.getLocalizedMessage());
						System.out.println("	Invite page text not displayed-----");
					}
					return null;
				}
				
				//'skip' on invite page
				public WebElement skipinvite()   
				{		
					try {
						WebDriverWait wait= new WebDriverWait(driver,60);
						System.out.println("	*Skip link on invite page should be displayed");
						WebElement ele =  wait.until(ExpectedConditions.elementToBeClickable(objMap.getLocator("skipinvite")));
						return   ele;
					} catch (Exception e){
						Reporter.log("Skip link on invite page not displayed-----"+e.getLocalizedMessage());
						System.out.println("	Skip link on invite page not displayed-----");
					}
					return null;
				}
				
				//hover the mouce
				public WebElement foodnichehover()   
				{		
					try {
						WebDriverWait wait= new WebDriverWait(driver,60);
						System.out.println("	*Foodniche connect hover should be displayed");
						WebElement ele =  wait.until(ExpectedConditions.elementToBeClickable(objMap.getLocator("foodnichehover")));
						return   ele;
					} catch (Exception e){
						Reporter.log("Foodniche connect not displayed-----"+e.getLocalizedMessage());
						System.out.println("	Foodniche connect not displayed-----");
					}
					return null;
				}
				//click hover the mouce
				public WebElement hoverclick()   
				{		
					try {
						WebDriverWait wait= new WebDriverWait(driver,60);
						System.out.println("	*Foodniche connect hover click should be displayed");
						WebElement ele =  wait.until(ExpectedConditions.elementToBeClickable(objMap.getLocator("hoverclick")));
						return   ele;
					} catch (Exception e){
						Reporter.log("Foodniche connect hover click not displayed-----"+e.getLocalizedMessage());
						System.out.println("	Foodniche connect hover click not displayed-----");
					}
					return null;
				}
	}
