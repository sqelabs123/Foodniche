...
//	public String url = "https://foodniche.me/";
//	public String userId = "asian.recipes@foodniche.me";
//	public String password = "123456789";
//	public static final String USERNAME = "vikram158";
//	public static final String AUTOMATE_KEY = "VHUY3Ttk2yQ39MKwkyQF";
	
	
	@Test(priority=1)
	@Parameters({"userId","password","url","USERNAME","AUTOMATE_KEY"})
	public void Posting_Pictures_Contents_by_Business_User(String userId,String password,String url, String USERNAME, String AUTOMATE_KEY) throws Exception { 
//		public void Posting_Pictures_Contents_by_Business_User() throws Exception {
...
//	    caps.setCapability("version", "55.0");
	    ...
	    caps.setCapability("build", "Business User Contents");
...
//		action_obj.username().sendKeys("asian.recipes@foodniche.com");
		Thread.sleep(1000);
		//Entering Password
		action_obj.Password().sendKeys(password);
//		action_obj.Password().sendKeys("123456789");
