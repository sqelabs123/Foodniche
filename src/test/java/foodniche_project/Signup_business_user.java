...
public class Signup_business_user  {
...
//	public static final String URL = "https://" + USERNAME + ":" + AUTOMATE_KEY + "@hub-cloud.browserstack.com/wd/hub";
	...
	public void SignUpForm(String userId,String password,String url, String USERNAME, String AUTOMATE_KEY) throws Exception {
	    ...
	    caps.setCapability("build", "Business User Signup");
		...
		Thread.sleep(1000);
		driver.get("https://foodniche.me/connect");
		Thread.sleep(100);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@type='file']")).sendKeys("C:\\Users\\hello\\Documents\\images\\wallpaper2.jpg");	
		Thread.sleep(2000);
